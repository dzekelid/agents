...
- name: Dezrez.Rezi.Client.Api - Add agent funds into the system
  x-api-slug: apireceiptagentdeposit-post
...
- name: Dezrez.Rezi.Client.Api - Withdraw funds for the agent
  x-api-slug: apireceiptwithdrawfunds-post
...
- name: Dezrez.Rezi.Client.Api - Get all tax held by agent
  x-api-slug: apitaxagentheld-get
